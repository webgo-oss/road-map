...
import { FilmPass }       from "https://cdn.jsdelivr.net/npm/three@0.129.0/examples/jsm/postprocessing/FilmPass.js";
...
new RGBELoader().setDataType(THREE.UnsignedByteType).load(
  'https://rawcdn.githack.com/mrdoob/three.js/r146/examples/textures/equirectangular/royal_esplanade_1k.hdr',
  (texture) => {
